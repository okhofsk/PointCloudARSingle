...
package com.example.okhof.pointcloudarsingle;
...
import com.example.okhof.pointcloudarsingle.rendering.BackgroundRenderer;
import com.example.okhof.pointcloudarsingle.rendering.PointCloudReader;
import com.example.okhof.pointcloudarsingle.rendering.PointClass;
...
public class MainActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    private static final String TAG = com.example.okhof.pointcloudarsingle.MainActivity.class.getSimpleName();
    ...
    private final int NUMBERBATCHELEMENTS = 54;
    private final int ALLELEMENTS = 54;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //-Permissions for external writing-
        ...
        batchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                batchList = new String[NUMBERBATCHELEMENTS];

                for (int i = 0; i < NUMBERBATCHELEMENTS; i++) {
                    try {
                        batchList[i] = br.readLine();
                        Log.d("ListNotification", "BatchList " + Integer.toString(i) + ": " + batchList[i]);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
    ...
    void writeFileLocation(String fileName){
        if(isExternalStorageWritable()) {
            ...
            try {
                ...
                outputStream.write("Format: time[1], location float[3], rotation quaterion float[4] \n".getBytes());
                outputStream.write(("Format: time[ms], " +
                        " x," +
                        " y," +
                        " z," +
                        " x = k.x * sin(theta/2)," +
    ...
    private void showSnackbarMessage(String message, boolean finishOnDismiss) {
        messageSnackbar =
                Snackbar.make(
                        com.example.okhof.pointcloudarsingle.MainActivity.this.findViewById(android.R.id.content),
                        message,
